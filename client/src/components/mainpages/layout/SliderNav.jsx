      ...
      <Slider className="main__slider-nav--slides" {...settings}>
        <div className="main__slider-nav--slides__slide slide-1">
          <div className="slide-1__content">
            ...
            <h2 className="slide__content--title">Holiday Season</h2>
            <span className="slide__content--span">
              Lorem Ipsum is simply dummy text of the printing
            </span>
            <Link to="#" className="slide__content--link">
              <div className="slide__content--link__content">Shop now</div>
        ...
        <div className="main__slider-nav--slides__slide slide-2">
          <div className="slide-2__content">
            ...
            <h2 className="slide__content--title title-uppercase">
              collection
            </h2>
            <span className="slide__content--span">
              Lorem Ipsum is simply dummy text of the printing
            ...
            <Link to="#" className="slide__content--link">
              <div className="slide__content--link__content">buy now</div>
              <i className="fas fa-caret-right"></i>
            </Link>
          </div>
        </div>
